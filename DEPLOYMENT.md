...
### Other config
 ...
 | `ERLANG_NODE_DISCOVERY_VIA_POSTGRES_CHANNEL_NAME` | The name of the Postgresql channel that is used when Erlang node discovery via Postgres is enabled.                                                                                                                                                             |
 | `ERLANG_NODE_DISCOVERY_VIA_POSTGRES_ENABLED`      | If set to `yes`, Lightning will use Postgres to discover Erlang nodes. This strategy will be used in addition to other strategies that are in use.                                                                                                              |
