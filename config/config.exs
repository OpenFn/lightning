...
# Declarative kickstarting (Lightning.Kickstart) is disabled by default. It is
# enabled in dev/test config, and can be opted into for a release by setting the
# ALLOW_KICKSTART=true environment variable (wired in Lightning.Config.Bootstrap).
config :lightning, Lightning.Kickstart, enabled: false
