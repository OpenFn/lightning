...
```
KAFKA_MEMORY_LIMIT=1000M KAFKA_MEMORY_RESERVE=1000M KAFKA_DEBUG=false docker-compose -f tooling/kafka_testing/docker-compose.kafka-testing-cluster.yml up -d
```
