...
/**
 * Error boundary for HistoryBrowserPanel
 *
 * Catches errors in the HistoryBrowserPanel and its children,
 * displaying a user-friendly error message with options to retry
 * or close the panel.
 *
 * Features:
 ...
 * @example
 * ```tsx
 * <HistoryBrowserPanelErrorBoundary onClose={handleClose}>
 *   <HistoryBrowserPanel {...props} />
 * </HistoryBrowserPanelErrorBoundary>
 * ```
 */
export class HistoryBrowserPanelErrorBoundary extends Component<Props, State> {
  ...
  override componentDidCatch(error: Error) {
    console.error('HistoryBrowserPanel error:', error);

    // Show toast notification
    notifications.alert({
      title: 'History browser error',
      description:
          ...
          <div className="text-center max-w-md">
            ...
            <p className="text-sm text-gray-600 mb-6">
              {this.state.error?.message ||
                'An error occurred while loading the history browser'}
            </p>
