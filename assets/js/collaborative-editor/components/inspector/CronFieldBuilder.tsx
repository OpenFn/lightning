        ...
        {showAdvanced && (
          <div className="mt-3">
            <input
              ...
              disabled={disabled}
              placeholder="0 0 * * *"
              className="block w-full px-3 py-2 border border-slate-300 rounded-md text-sm focus:border-indigo-500 focus:ring-indigo-500 focus:outline-none focus:ring-1 font-mono text-slate-700"
            />
          </div>
        )}
      </div>
