defmodule LightningWeb.API.ProvisioningJSON do
  ...
  alias Lightning.Workflows.{Workflow, Edge, Job, Trigger}
  ...
  def as_json(%Edge{} = edge) do
    ...
    |> Map.take(
      ~w(id source_job_id source_trigger_id condition_type condition_label condition_expression target_job_id)a
    )
    |> drop_keys_with_nil_value()
  end
