defmodule LightningWeb.Components.Settings do
  ...
  def list_menu_item(assigns) do
    base_classes = ~w[px-3 py-2 rounded-md text-sm font-medium rounded-md block]

    active_classes = ~w[text-primary-500 bg-secondary-200 dark:bg-gray-700] ++ base_classes

    inactive_classes = ~w[text-primary-400 hover:bg-secondary-200] ++ base_classes
