defmodule LightningWeb.Components.Modal do
          ...
          <div class={@width}>
            <.focus_wrap
              ...
              class={[
                ...
                "bg-white shadow-lg shadow-zinc-700/10 ring-1 ring-zinc-700/10"
              ]}
            >
              <header :if={@title != []} class="p-4">
                <h1
                  id={"#{@id}-title"}
              ...
              <div
                :if={@title != []}
                class="flex-grow bg-gray-100 h-0.5"
              >
              </div>
              <section class="py-4">
  ...
  def modal_footer(assigns) do
    ~H"""
    <div class="flex-grow bg-gray-100 h-0.5"></div>
    <footer class={@class}>
      {render_slot(@inner_block)}
    </footer>
    """
