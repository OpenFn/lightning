defmodule LightningWeb.RunLive.Components do
  ...
  attr :filters_changeset, :map, required: true

  slot :inner_form_block, required: true
  slot :title
  slot :subtitle
  ...
  def filter_modal(assigns) do
    ...
    <div id={@id} phx-mounted={@show && show_modal(@id)} class="relative z-50 hidden">
      <div
        ...
        aria-hidden="true"
      />
      <div class="fixed overflow-y-auto" role="dialog" aria-modal="true" tabindex="0">
        <div class="flex min-h-full items-center justify-center">
          <div class="w-full max-w-3xl p-4">
            <div
              ...
              class="hidden relative rounded-lg bg-white p-3 shadow-lg shadow-zinc-700/10 ring-1 ring-zinc-700/10 transition"
            >
              <div id={"#{@id}-content"}>
                <.form
                  :let={form}
                ...
                >
                  ...
                  <%= render_slot(@inner_form_block, form) %>

                  <div class="mt-4 mb-4 flex items-center gap-5">
                    <button
                      id={"#{@id}-confirm"}
                      type="submit"
                      class="inline-flex w-full justify-center rounded-md bg-indigo-600 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600 sm:col-start-2"
