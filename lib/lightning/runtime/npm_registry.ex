defmodule Lightning.Runtime.NpmRegistry do
  @moduledoc false
  require Logger
  ...
  def fetch_package!(name, version) do
    ...
    Logger.debug("Downloading ws-worker from #{url}")
  ...
  defp fetch_file!(url) do
    case do_fetch(url) do
      ...
      other ->
        ...
        You may also install the "ws-worker" executable manually, \
        see the docs: https://github.com/openfn/kit/packages/ws-worker
        """
    end
  end
